...
::: {.callout-important}
## **Wichtig**
Dazu muss der gesamte Ordner **"Schwarz_TaxtoEquality_HA-Replikation"** als Projekt in R geöffnet werden und dieser zuvor vollständig heruntergeladen worden sein. Nach dem herunterladen des Ordners muss daher die **"HA_Justice.Rproj"**-Datei (R Projekt) geöffnet werden. Danach kann innerhalb von RStudio die **HA_Justice.qmd**-Datei (Quarto Dokument) unter "**Files**" aufgerufen und verwendet werden.
:::
